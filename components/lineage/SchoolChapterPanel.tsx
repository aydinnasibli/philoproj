        ...
        >
          ...
          <div className="sticky top-0 z-10 px-6 pt-4.5 pb-[14px] flex items-start justify-between bg-stone-50/96 dark:bg-stone-900/96 backdrop-blur-[20px] border-b border-zinc-200 dark:border-zinc-700">
            ...
            <button
              ...
              className="cursor-pointer bg-transparent border-none text-zinc-950/35 dark:text-stone-100/35 px-1.5 py-1 mt-1 transition-colors duration-200 hover:text-zinc-950 dark:hover:text-stone-100 flex items-center justify-center"
            >
