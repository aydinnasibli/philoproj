...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center font-serif gap-6 text-center p-8">
      ...
      <Link href="/" className="font-sans text-xs font-bold tracking-widest uppercase text-zinc-700 dark:text-zinc-400 no-underline border-b border-current pb-0.5">
