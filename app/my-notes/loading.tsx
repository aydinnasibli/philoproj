  ...
  return (
    <div className="h-screen flex overflow-hidden animate-sk-appear bg-(--mn-bg)">
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        <div className="px-6 py-[11px] border-b border-(--mn-border) flex items-center gap-[14px] shrink-0 bg-(--mn-surface)">
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <div className="w-[260px] h-[30px] rounded-[3px] bg-(--sk-bg-soft) animate-sk-pulse [animation-delay:0.08s]" />
          </div>
        </div>
      ...
      <div className="w-[52px] bg-(--mn-panel) border-l border-(--mn-border) flex flex-col items-center py-[14px] gap-[6px] shrink-0">
