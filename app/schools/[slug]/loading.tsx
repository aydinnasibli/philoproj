  ...
  return (
    <div className="min-h-screen pl-0 md:pl-20 animate-pulse">
      <div className="max-w-[820px] mx-auto px-4 md:px-12 pt-10 md:pt-16 pb-16 md:pb-24">
        ...
        <div className="w-[72px] h-[22px] rounded-sm bg-amber-800/10 dark:bg-amber-600/10 animate-pulse mb-4" />
        <div className="w-[300px] h-[52px] rounded-sm bg-zinc-950/8 dark:bg-stone-100/8 animate-pulse mb-7" />
        <div className="flex items-center gap-3 mb-9">
          <div className="flex-1 h-px bg-amber-800/10 dark:bg-amber-600/10 animate-pulse" />
          <div className="w-2 h-2 rounded-full bg-amber-800/10 dark:bg-amber-600/10 animate-pulse [animation-delay:0.06s]" />
          <div className="flex-1 h-px bg-amber-800/10 dark:bg-amber-600/10 animate-pulse [animation-delay:0.06s]" />
        </div>
          ...
          <div className="flex flex-col gap-3">
            {IDEA_WIDTHS.map((w, i) => (
              <div key={i} className="flex gap-3.5 items-center">
                <div className="w-1 h-1 rounded-full bg-amber-800/10 dark:bg-amber-600/10 shrink-0" />
          ...
          <div className="flex flex-col gap-0.5">
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className={`flex items-center gap-3.5 px-4 py-3.5 bg-stone-50/60 dark:bg-stone-900/60 border border-zinc-100 dark:border-zinc-800 ${DELAYS[i]}`}>
                <div className="size-[42px] rounded-full shrink-0 bg-amber-800/10 dark:bg-amber-600/10 animate-pulse" />
                ...
                <div className="ml-auto w-10 h-[9px] rounded-sm bg-amber-800/10 dark:bg-amber-600/10 animate-pulse" />
              </div>
            ))}
          </div>
        </div>
