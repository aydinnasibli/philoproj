  ...
  return (
    <div className="max-w-[1400px] mx-auto px-4 md:px-10 pt-8 md:pt-24 pb-12 animate-pulse">
      <div className="grid grid-cols-1 md:grid-cols-[1fr_320px] gap-8 md:gap-16 items-start">
        <article>
          <div className="-mx-4 md:-mx-10 px-4 md:px-10 pt-8 pb-8 md:pb-10 mb-8 bg-amber-800/10 dark:bg-amber-600/10 border-t-4 border-t-amber-800/10 dark:border-t-amber-600/10">
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-start">
              ...
              <div className="pt-2 flex flex-col gap-4">
                <div className="w-20 h-[10px] rounded-sm bg-amber-800/10 dark:bg-amber-600/10 animate-pulse [animation-delay:0.06s]" />
          ...
          <div className="pl-6 mb-8 border-l-2 border-l-amber-800/10 dark:border-l-amber-600/10">
          ...
          <section className="mt-12">
            <div className="w-20 h-[9px] rounded-sm bg-amber-800/10 dark:bg-amber-600/10 animate-pulse mb-6" />
