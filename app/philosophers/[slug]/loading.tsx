  ...
  return (
    <div className="max-w-[1400px] mx-auto px-10 pt-24 pb-12 animate-sk-appear">
      <div className="grid grid-cols-[1fr_320px] gap-16 items-start">
        <article>
          <div className="-mx-10 px-10 pt-8 pb-10 mb-8 bg-(--sk-accent) border-t-4 border-t-(--sk-accent)">
            ...
            <div className="flex gap-10 items-start">
              <div className="w-[200px] h-[200px] rounded-full shrink-0 bg-(--sk-bg) animate-sk-pulse" />
